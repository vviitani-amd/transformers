...
def load_global_variables():
    global tensors_mi300
    global tensors_h100

    filename_mi300 = "global_tensors_MI300.pt"
    filename_h100 = "global_tensors_H100.pt"

    tensors_mi300 = torch.load(filename_mi300)
    tensors_h100 = torch.load(filename_h100)    
